    ...
    <footer className="footer">
      <div className="footer-container">
        <div className="footer-info">
          <a href="#" className="logo h6 text-600">
            <svg
              className="elogo--small"
          ...
          <p className="text-md my-1 text-primary">
            Making the world a better place, by - gavlin &amp; biswanath
          </p>
          <div className="footer-contact">
            <div>
              <p className="text-lg">Email me at</p>
              <p className="text-sm text-tertiary">iambiswanath@gmail.com</p>
            </div>
            <div>
              <p className="text-lg">Call us</p>
              <p className="text-sm text-tertiary">8906XXXXXX</p>
            </div>
          </div>
        </div>
        <div className="footer-info">
          <p href="#" className="h6 text-600 text-primary">
            Lets Talk!
          </p>
          <p className="text-md my-1 text-primary">
            We are always up to discuss how we can defeat piedpipers once and
            for all.
          </p>
          <div className="footer-icon-container">
            <a
              href="https://www.facebook.com/tewari.biswanath00/"
              className="btn-icon-secondary btn-icon-sm"
              target="_blank"
              rel="noreferrer"
            >
      ...
      <div className="footer-legal">
        <p className="text-md text-tertiary">
          © 2022 Hooli Views. All rights reserved.
        </p>
        <p className="text-md text-tertiary">
